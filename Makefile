...
EXCLUDE_MD = README.md LAYOUT.md FAQ.md DESIGN.md CONTRIBUTING.md CONDUCT.md CUSTOMIZATION.md SETUP.md LICENSE.md
...
%.html : %.md _layouts/page-md.html $(FILTERS)
	${PANDOC} -s -t html \
	    ${PANDOC_FLAGS} \
	    --template=_layouts/page-md \
